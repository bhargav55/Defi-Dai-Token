...
module.exports = async function(deployer,_network,accounts) {
  ...
  //await deployer.deploy(MyDefiProject,"0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa");
  await deployer.deploy(MyDefiProject,"0x4f96fe3b7a6cf9725f59d353f723c1bdb64ca6aa");
  const account="0x38c60F3fc945339504d3e24DC47e1506B11e6AeC";
  await web3.eth.accounts.wallet.add("66e4168c3472c6cb8d2241ca583bd504bafe3af490caf5ceb5f4c125c5781277");
  const myDefiProject = await MyDefiProject.deployed();
  console.log("account :",accounts[0])
    //await dai.transfer(myDefiProject.address,100, {from:accounts[0]})
    await dai.methods.transfer(myDefiProject.address,1).send({
        from:accounts[0],
        gasLimit:6000000,
        gasPrice: web3.utils.toWei("20","Gwei")
    })

    await myDefiProject.foo(account,1)
  //await dai.faucet(myDefiProject.address,100);
  //await myDefiProject.foo(accounts[0],100);

  const balance0 = await dai.methods.balanceOf(myDefiProject.address).call()
  const balance1 = await dai.methods.balanceOf(account).call()
